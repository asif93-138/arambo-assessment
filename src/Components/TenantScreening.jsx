        ...
        <div className="grid lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 pb-0 w-9/10 absolute bottom-5 left-[5%]">
              <h3 className="md:text-lg font-semibold text-gray-900 mb-4">Arambo Supports:</h3>
              <div className="md:space-y-2">
                {aramboSupports.map((item, index) => (
                  <div key={index} className="flex items-start gap-3">
                    ...
                    <span className={"text-gray-700 text-xs md:text-sm " + calcOpacity(index)}>{item}</span>
                  </div>
                ))}
              </div>
            </div>
