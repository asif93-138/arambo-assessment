    ...
    return (
        <div className="my-20">
            <section className='max-w-5xl mx-auto flex'>
                ...
                <p className='text-gray-600 '>Our work has been recognized by Bangladesh's top news outlets and media channels.
                     We're proud to be shaping the future of property with trust, transparency, and national impact.
                </p>
            </section>
            <section className="flex mt-15 w-9/10 mx-auto">
                <div className="bg-[#F6F7F9] font-semibold m-2 p-5 rounded-xl">
